...
describe('Placeholder', () => {
  it('should show placeholder if no initial values', () => {
    const wrapper = mount(
      <Placeholder placeholder="No selected values" allSelected={false} />
    );
  ...
  it('should default to None Selected if no placeholder supplied', () => {
    const wrapper = mount(<Placeholder allSelected={false} />);
