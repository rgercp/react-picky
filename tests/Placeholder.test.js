...
describe('Placeholder', () => {
  it('should show placeholder if no initial values', () => {
    const wrapper = mount(
      <Placeholder id="id" placeholder="No selected values" />
    );
